...
namespace DB
{
  ...
  {
  public:
  ProtobufRowInputStream(ReadBuffer & istr_, const Block & header_, const String & schema_dir, const String & root_obj): istr(istr_), header(header_), log(&Poco::Logger::get("ProtobufRowInputStream"));
